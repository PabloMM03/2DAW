...
if(isset($_POST['añadirAlCarrito'])){
    ...
    //Se crea un array con los datos del producto a añadir al carrito
            ...
            $producto = array($codProd,$nombreProd,$precioProd,$familiaProd);
    //añadimos el producto al carrito
    $_SESSION['carritoCompra'][$codProd] = $producto;
    ...
    foreach($_SESSION['carritoCompra'] as $cod=> $producto){
        echo "<h4>Articulo añadido: $cod</h4>";
        $carrito_vacio = false;
    }
}
