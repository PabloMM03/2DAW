    ...
    function getHTMLCliente(cliente) 
    {
        ...
        tr.innerHTML =   ` 
            ...
            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm leading-5">
                ...
                <a href="#" class="block text-teal-600 hover:text-teal-900 mr-2 editarcliente" data-clientenombre="${cliente.nombre}" data-clienteapellidos="${cliente.apellidos}" data-clientenif="${cliente.nif}">Editar Cliente</a>
 ...
 */
    function accionesCita(e)
    {
        ...
        if(classList.includes('editarcliente')){
            almacenarDatos(e);
